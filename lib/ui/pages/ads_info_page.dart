...
class AdsInfoPage extends StatefulWidget {
  const AdsInfoPage({Key? key, required this.adsModel, this.tag})
      : super(key: key);
        ...
        child: Column(
          ...
          children: [
                        ...
                        itemBuilder: (context, index) {
                          return AnimatedContainer(
                            ...
                            child: Padding(
                              ...
                              child: widget.adsModel.images.length == 1
                                  ? Container()
                                  : Icon(
                                      _current == index
                                          ? Icons.lens
            ...
            Padding(
              ...
              child: Text(
                  '${'date'.tr}:  ${widget.adsModel.date ?? '__.__.____'}'),
            ),
            Container(
              margin: const EdgeInsets.symmetric(vertical: 10, horizontal: 16),
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      widget.adsModel.address == null ||
                              widget.adsModel.address!.isEmpty
                          ? "noAddress".tr
                          : widget.adsModel.address!,
                      style: AppFonts.w500s16,
                    ),
                  ),
                ],
            ...
            Padding(
              ...
              child: InkWell(
                  onTap: () {
                    Clipboard.setData(
                        ClipboardData(text: widget.adsModel.phone));
                    snackBar(context, msg: 'Copy');
                  },
                  child: Text(
                    '${'phoneNumber'.tr}: ${widget.adsModel.phone ?? ''}',
