...
class _UpdateBalanceInfoState extends State<UpdateBalanceInfo> {
  ...
  void initState() {
    super.initState();
    auth  = RepositoryProvider.of<AuthRepo>(context);
    _getUser();
  }
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            AppContactButton(isWhatsApp: true,  number: '79254303450',user: user,),
            const SizedBox(height: 10,),
            AppContactButton(isWhatsApp: false,  number: '79254303450',user: user),
            const Spacer(),
