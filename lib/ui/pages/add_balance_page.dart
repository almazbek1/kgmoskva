...
class _AddBalancePageState extends State<AddBalancePage> {
  bool isSearch = false;
  Widget appBarWidget = const Text('Жарыя беруу');
  @override
              ...
              if(isSearch){
                appBarWidget = Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (val){
                      BlocProvider.of<AdminBloc>(context).add(AdminSearchEvent(searchText: val));
                    },
                  ),
                );
              }else{
                appBarWidget = const Text('Жарыя беруу');
                BlocProvider.of<AdminBloc>(context).add(AdminSearchEvent(searchText: ''));
