...
class _AppDrawerState extends State<AppDrawer> {
  ...
  Future<void> _getUser() async {
    user = RepositoryProvider.of<AuthRepo>(context).getUser();
    setState(() {
      user = user;
    });
  }
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all<Color>(AppColors.ttrnur)),
              onPressed: () {
                if (user == null) {
                  Navigator.of(context).pop();
                  Navigator.pushNamed(context, AppRoutsName.loginPage);
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, AppRoutsName.updateBalanceInfo);
              },
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                    "${'balance'.tr}: ${user!.balance}${'som'.tr}",
                                    style: const TextStyle(
